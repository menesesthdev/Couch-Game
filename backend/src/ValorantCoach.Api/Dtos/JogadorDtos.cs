...
/// <summary>Linha do histórico de RR. O <c>MatchId</c> abre o scoreboard completo em /api/partidas.</summary>
public sealed record PartidaDto(
    string? MatchId, DateTimeOffset Data, MapaDto? Mapa, int VariacaoRR, ResultadoPartida Resultado, RankDto? RankApos);
    ...
    public static PerfilResponse De(PerfilConsultado c)
    {
        ...
        return new PerfilResponse(
            ...
            partidas.Select(p => new PartidaDto(
                p.MatchId, p.Data, MapaDto.De(p.Mapa), p.VariacaoRR,
